...
def make_plots(files, names, my_calibs):
    ...
    hist_list[0].SetTitle("Spectrum Pulser on Cathode")
    ...
    c1.Print("/afs/slac.stanford.edu/u/xo/mjj46/Test_Stand/LXe_4th/Group_Meeting/plots/Data_Pulser_noHV.png")
    
    
    hist_list[0].GetXaxis().SetRangeUser(0,2000)
    c1.Update()
    c1.Print("/afs/slac.stanford.edu/u/xo/mjj46/Test_Stand/LXe_4th/Group_Meeting/plots/Data_Pulser_noHV_zoom.png")
    raw_input()
...
if __name__ == "__main__":
   ...
   files = ["/afs/slac.stanford.edu/u/xo/mjj46/Test_Stand/LXe_4th/MCA/LXe_10V_point2perThreshold_cathPulser_BiasX27_Bi207.mca"]

   names = ["Pulser on Cathode"]
   my_calibs = [1.0]
